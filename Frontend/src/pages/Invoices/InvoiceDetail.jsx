...
const InvoiceDetail = () => {
  ...
  if(!invoice) {
    return (
      <div className='flex flex-col items-center justify-center py-12 text-center bg-slate-50 rounded-lg'>
        ...
        <h3 className='text-lg font-medium text-slate-50'>Invoice not found.</h3>
  ...
  if(isEditing) {
    return  <CreateInVoices existingInvoice={invoice} onSave={handleUpdate}/>
  }
  return (
    <>
    <ReminderModal isOpen={isReminderModalOpen} onClose={() => setIsReminderModalOpen(false)} invoiceId={id}/>
      ...
      <div id='invoice-content-wrapper'>
        ...
        id='invoice-preview'
        >
          <div className='flex flex-col sm:flex-row justify-between items-start pb-8 border-slate-200'>
            <div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 my-2'>
            <div>
          ...
          <div className='bg-white border border-slate-200 rounded-lg  overflow-hidden'>
            <table className='w-full divide-y divide-slate-200'>
              <thead className='bg-slate-50'>
                <tr>
                  <th className='px-4 sm:px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider mb-3'>Item</th>
                  <th className='px-4 sm:px-6 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider mb-3'>Qty</th>
                  <th className='px-4 sm:px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider mb-3'>Price</th>
                  <th className='px-4 sm:px-6 py-3 text-right text-xs font-medium text-slate-500 uppercase tracking-wider mb-3'>Total</th>
                </tr>
              </thead>
          ...
          <div className='flex justify-end mt-8'>
            <div className='w-full max-w-sm space-y-3'>
              ...
              <div className='flex justify-between font-semibold text-lg text-slate-900 border-t border-slate-200 '>
                <span>Total</span>
