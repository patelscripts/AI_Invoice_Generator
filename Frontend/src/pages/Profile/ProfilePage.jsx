...
const ProfilePage = () => {
  ...
  return (
    <div className='bg-white broder border-slate-200 rounded-lg shadow-sm overflow-hidden max-w-4xl mx-auto'>
        ...
        <div className='p-6 space-y-6'>
          ...
          <div className='pt-6 border-t border-slate-200'>
            ...
            <div className='space-y-4'>
              ...
              <TextareaField label="Address" name="address" icon={MapPin} value={formData.address} onChange={handleInputChange} placeholder="Mumbai, India, 233232"/>
              <InputField label="Phone" name="phone" icon={Phone} type="tel" value={formData.phone} onChange={handleInputChange} placeholder="+91 332424232"/>
            </div>
          </div>
        </div>
