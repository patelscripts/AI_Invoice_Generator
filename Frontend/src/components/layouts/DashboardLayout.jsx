...
const NavigationItem = ({item, isActive, onClick, isCollapsed}) => {
  ...
  return (
    <button
      ...
      className={`w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 cursor-pointer group ${
        isActive
      ...
      <div
       className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform ${
        ...
        <div className='absolute bottom-4 left-4 right-4'>
          <button
            className='w-full flex items-center px-3 py-2.5 font-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200'
            onClick={logout}
          >
