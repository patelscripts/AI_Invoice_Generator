...
function CreateWithAIModal({isOpen, onClose}){
                ...
                <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
                    ...
                    <div className="space-y-4">
                        <p className="text-sm text-slate-600">
                            Paste any text that contains invoice details (like client name, items, quantites, and prices) and the AI will attempt to create  an invoice form it.
                        </p>
                        <TextareaField
                        name="invoiceText"
